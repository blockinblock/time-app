(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FooterComponent = /** @class */ (function () {
                function FooterComponent(messageService, timeUtilsService) {
                    var _this = this;
                    ...
                    this.timeUtilsService.setTimeWindow$.subscribe(function (value) {
                        _this.timeArray = value;
                    });
                    // Get the clock
                    this.timeUtilsService.time.subscribe(function (now) {
                        _this.curTime = now.toLocaleTimeString();
                    });
                }
                /**
                 ...
                 */
                FooterComponent.prototype.formatLabel = function (value) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MapComponent = /** @class */ (function () {
                function MapComponent(messageService, timeUtilsService) {
                    var _this = this;
                    this.messageService = messageService;
                    this.timeUtilsService = timeUtilsService;
                    this.map = null;
                    ...
                    this.messageService.setMessage$.subscribe(function (value) {
                        _this.selectedTime = value;
                        if (_this.map) {
                            _this.removeTimeLayer();
                            _this.createTimeLayer(_this.selectedTime);
                            console.log('this.selectedTime: ' + _this.selectedTime);
                        }
                    });
                    // Current time is used for the initial fetch of the WMS time layer
                    this.timeUtilsService.setTime$.subscribe(function (value) {
                        _this.currentTime = value;
                        console.log('currentTime: ' + _this.currentTime);
                    });
                    // Refresh time layer every 5 mins
                    this.timeUtilsService.fiveMin.subscribe(function (value) {
                        _this.selectedTime = value;
                        if (_this.map) {
                            _this.removeTimeLayer();
                            _this.createTimeLayer(_this.selectedTime);
                 ...
                 */
                MapComponent.prototype.removeTimeLayer = function () {
                    var _this = this;
                 ...
                 */
                MapComponent.prototype.createTimeLayer = function (time) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TimeUtilsService = /** @class */ (function () {
                function TimeUtilsService(datePipe) {
                    var _this = this;
                    ...
                    this.timeWindow = [];
                    // One second timer
                    this.time$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["timer"])(0, 1000).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (tick) { return new Date(); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["shareReplay"])(1));
                    // Five minute timer (rounded to nearest 5 mins)
                    this.rounded = this.roundDateTime(this.currentDate, 5);
                    this.fiveMinTimer$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["timer"])(this.rounded, 300000).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (tick) { return _this.formatDateTime(_this.roundDateTime(new Date(), 5)); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["shareReplay"])(1));
                ...
                Object.defineProperty(TimeUtilsService.prototype, "time", {
                    /**
                ...
                Object.defineProperty(TimeUtilsService.prototype, "fiveMin", {
                    /**
                 ...
                 */
                TimeUtilsService.prototype.setCurDateTimeStr = function () {
                    var rounded = this.roundDateTime(this.currentDate, 5);
                 ...
                 */
                TimeUtilsService.prototype.formatDateTime = function (date) {
                    var formatted = this.datePipe.transform(date, 'yyyy-MM-ddTHH:mm').concat(':00.000Z');
                    return (formatted);
                };
                /**
                 ...
                 */
                TimeUtilsService.prototype.addMinutes = function (date, minutes) {
                 ...
                 */
                TimeUtilsService.prototype.roundDateTime = function (date, minutes) {
